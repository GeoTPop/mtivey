function g=gpoly2d(x0,z0,xcorn,zcorn,ncorn,rho)
% gpoly
% Compute vertical attraction of a two dimensional body
% with polygonal cross-section for a profile array x0,z0
% All distances in km
...
% Usage:
%  g=gpoly2d(x0,z0,xcorn,zcorn,ncorn,rho)
%
% After Blakely, 1995
% Maurice A. Tivey MATLAB July 2002
%
if nargin < 1
 fprintf('DEMO gpoly2d')
 help gpoly2d
 x0=-10:.25:10;
 z0=zeros(size(x0));
 ...
 title('DEMO gpoly2d: Gravity over a polygon extending to \infty along y-axis')
 subplot(212)
